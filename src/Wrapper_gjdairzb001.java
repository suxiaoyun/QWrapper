...
//		String getUrl ="http://bookflights.monarch.co.uk/SearchSelect.aspx?roundtrip=False&origin=LTN&destination=FCO&outbounddate=20140727&adult=1&child=0&infant=0&lff=False&offer=False";
	...
	public ProcessResultInfo process(String arg0, FlightSearchParam arg1) {
		...
		if (html.contains("Today Flight is full, select an other day or check later for any seat released. ")||html.contains("All charter flights booked using this process are booked with our award winning sister company Avro and are ATOL protected.")) {
			result.setRet(false);
			result.setStatus(Constants.INVALID_DATE);
			return result;			
		}
		if (html.contains("We do not have any flights available which match your chosen criteria, please select an alternative destination and / or departure date. ")) {
			result.setRet(false);
	...
	public static void main(String[] args) {
		...
		searchParam.setArr("RHO");
		searchParam.setDepDate("2014-7-09");
